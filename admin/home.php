...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['id'])) {
        // Edição
        $id = (int)$_POST['id'];
        $sql = "UPDATE home SET titulo = ?, texto = ?, ling = ? WHERE id = ?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssi", $titulo, $texto, $ling, $id);
    } else {
        // Adição
        $sql = "INSERT INTO home (titulo, texto, ling) VALUES (?, ?, ?)";
        $stmt = $conn->prepare($sql);
...
<head>
    ...
    <title>Controlar Página Inicial - Green Shop Admin</title>
...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>Controlar Página Inicial</h1>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary" onclick="editHome(<?php echo htmlspecialchars(json_encode($row)); ?>)">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Página Inicial</h5>
    ...
    <script>
        function editHome(home) {
            document.getElementById('home_id').value = home.id;
            document.getElementById('titulo').value = home.titulo;
            document.getElementById('texto').value = home.texto;
            document.getElementById('ling').value = home.ling;
